...
" NOTE: disable these because ALE can do this
...
xmap mp  <Plug>(coc-format-selected)
...
xmap ms  <Plug>(coc-codeaction-selected)<CR>
nmap ms  <Plug>(coc-codeaction-selected)<CR>
...
nnoremap <silent><nowait> mg  :<C-u>CocList diagnostics<cr>
" " Manage extensions.
