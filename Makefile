coc:
	sudo pacman -S python-black python-jedi python-pylint python-rope
	npm i -g graphql-language-service-cli sql-language-server

install:
	rm -rf ~/.local/share/nvim/site/pack/packer/start/packer.nvim
	sudo pacman -S --noconfirm deno neovim ruby fzf fd xclip the_silver_searcher ripgrep bat git-delta python-pynvim postgresql-libs
