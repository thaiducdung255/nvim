require('gitsigns').setup {
   ...
   keymaps           = {
      ...
      ['n gf'] = '<cmd>lua require"gitsigns".reset_hunk()<CR>',
      ['v gf'] = '<cmd>lua require"gitsigns".reset_hunk({vim.fn.line("."), vim.fn.line("v")})<CR>',
      ['n gF'] = '<cmd>lua require"gitsigns".reset_buffer()<CR>',
