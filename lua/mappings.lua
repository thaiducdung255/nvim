...
-- key mods
---- symbol maps
Icmap(Keycodes.sys.key_mod.symbol.exclamation,  '!')
Icmap(Keycodes.sys.key_mod.symbol.at_sign,      '@')
Icmap(Keycodes.sys.key_mod.symbol.sharp,        '#')
Icmap(Keycodes.sys.key_mod.symbol.dollar,       '$')
Icmap(Keycodes.sys.key_mod.symbol.percent,      '%')
Icmap(Keycodes.sys.key_mod.symbol.power,        '^')
Icmap(Keycodes.sys.key_mod.symbol._and,         '&')
Icmap(Keycodes.sys.key_mod.symbol.star,         '*')
Icmap(Keycodes.sys.key_mod.symbol.open_parent,  '(')
Icmap(Keycodes.sys.key_mod.symbol.close_parent, ')')
Icmap(Keycodes.sys.key_mod.symbol.minus,        '-')
Icmap(Keycodes.sys.key_mod.symbol.equal,        '=')
Icmap(Keycodes.sys.key_mod.symbol.dangle,       '_')
Icmap(Keycodes.sys.key_mod.symbol.plus,         '+')

Imap(Keycodes.sys.key_mod.symbol.nl, ',<CR>')
-- vim.cmd('inoremap ,, ,<CR>')
--
Nmap(Keycodes.sys.key_mod.cmd_nav.mru, ':<Up>')
Cmap(Keycodes.sys.key_mod.cmd_nav.l, '<Left>')
Cmap(Keycodes.sys.key_mod.cmd_nav.next, '<C-n>')
Cmap(Keycodes.sys.key_mod.cmd_nav.prev, '<C-p>')
Cmap(Keycodes.sys.key_mod.cmd_nav.r, '<Right>')
